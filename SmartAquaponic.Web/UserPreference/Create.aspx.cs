    ...
    public partial class Create : CustomPage
    {
        ...
        protected void BtnCreate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var result = new UserPreferenceBll(this.GetUser(), this.GetIp()).Create(
                        new UserPreference()
                        {
        ...
        private void Build()
        {
            ...
            {
                this.IsUserAuthorized(Constants.Permission.CreateLanguage);
                this.SetControls();
            }
        }
        ...
        private bool IsEntityValid()
        {
            ...
            if (string.IsNullOrEmpty(this.TxtDateFormat.Text) || this.TxtDateFormat.Text.Length > 50)
            {
            ...
            if (string.IsNullOrEmpty(this.TxtTimeZone.Text) || this.TxtTimeZone.Text.Length > 50)
            {
