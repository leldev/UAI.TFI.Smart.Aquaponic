<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="SmartAquaponic.Web.Decor.Create" %>

<%@ Register Src="~/Controls/AlertControl.ascx" TagName="AlertControl" TagPrefix="sa" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LblCreateDecorTitle" runat="server" CssClass="display-4 text-success text-uppercase" />
    ...
    <asp:Panel ID="PnlMain" runat="server" CssClass="jumbotron">
        <div class="form-row">
            ...
            <div class="form-group col-md col-sm-12">
                ...
                <asp:TextBox ID="TxtType" runat="server" CssClass="form-control" MaxLength="50" required="" />
                <div class="invalid-feedback">
