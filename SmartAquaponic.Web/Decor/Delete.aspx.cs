...
namespace SmartAquaponic.Web.Decor
{
    ...
    public partial class Delete : CustomPage
    {
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                var result = new DecorBll(this.GetUser(), this.GetIp()).Delete(
                    new Decor()
                    {
        ...
        private void LoadData()
        {
            ...
            else
            {
                ...
                {
                    this.LblNameValue.Text = decor.Name;
                    this.LblTypeValue.Text = decor.Type;
                    this.LblVolumeValue.Text = decor.Volume.ToString();
