...
var guis = {
	...
	BoxGeometry: function (mesh, newGui) {
		...
		var folder;
		if (newGui) {
			folder = newGui.addFolder('THREE.BoxGeometry');
		}
		else {
			folder = gui.addFolder('THREE.BoxGeometry');
        }
