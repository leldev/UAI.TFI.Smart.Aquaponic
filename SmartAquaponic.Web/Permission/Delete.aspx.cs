...
namespace SmartAquaponic.Web.Permission
{
    ...
    public partial class Delete : CustomPage
    {
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                var result = new PermissionBll(this.GetUser(), this.GetIp()).Delete(
                    new Group()
                    {
        ...
        private void Build()
        {
            ...
            {
                this.IsUserAuthorized(Constants.Permission.DeletePermission);
                this.SetControls();
                this.LoadData();
            }
        }
        ...
        private void LoadData()
        {
            ...
            {
                var group = new PermissionBll().Read(id);
                ...
                else
                {
                    ...
                    this.RptRoles.DataSource = group.Roles;
