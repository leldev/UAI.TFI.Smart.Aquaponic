<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SmartAquaponic.Web.Permission.Default" %>

<%@ Register Src="~/Controls/AlertControl.ascx" TagName="AlertControl" TagPrefix="sa" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LblPermisionTitle" runat="server" CssClass="display-4 text-success text-uppercase" />
                    ...
                    <table class="table table-hover text-center">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">
                                    <asp:Literal ID="LtlRoleCount" runat="server" />
                                </th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="font-weight-bold">
                        <%#Eval(nameof(SmartAquaponic.Domain.Group.Name))%>
                    </td>
                    <td>
                        <asp:Label ID="LblRoles" runat="server" data-toggle="tooltip" data-html="true" CssClass="btn-link text-primary" />
                    </td>
