...
namespace SmartAquaponic.Web.Lamp
{
    ...
    public partial class Default : CustomPage
    {
        ...
        {
            this.BtnCreate.NavigateUrl = Constants.Pages.CreateLamp;
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                var item = e.Item.DataItem as Lamp;
                ...
                lnkUpdate.NavigateUrl = $"{Constants.Pages.UpdateLamp}?{Constants.QueryStrings.Id}={item.Id}";
                lnkDelete.NavigateUrl = $"{Constants.Pages.DeleteLamp}?{Constants.QueryStrings.Id}={item.Id}";
            }
        }
    }
}