<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SmartAquaponic.Web.Lamp.Default" %>

<%@ Register Src="~/Controls/AlertControl.ascx" TagName="AlertControl" TagPrefix="sa" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LblLampTitle" runat="server" CssClass="display-4 text-success text-uppercase" />
                    ...
                    <table class="table table-hover text-center">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">
                                    <asp:Literal ID="LtlLumen" runat="server" />
                                </th>
                                <th scope="col">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td class="font-weight-bold">
                        <%#Eval(nameof(SmartAquaponic.Domain.Lamp.Name))%>
                    </td>
                    <td>
                        <%#Eval(nameof(SmartAquaponic.Domain.Lamp.Lumen))%> lm
                    </td>
                    <td>
                        <%#Eval(nameof(SmartAquaponic.Domain.Lamp.Power))%> w
                    </td>
                    <td>
                        <asp:Literal ID="LtlSocket" runat="server" />
                    </td>
