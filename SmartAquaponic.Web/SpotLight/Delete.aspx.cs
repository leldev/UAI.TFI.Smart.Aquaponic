...
namespace SmartAquaponic.Web.SpotLight
{
    ...
    public partial class Delete : CustomPage
    {
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                var result = new SpotLightBll(this.GetUser(), this.GetIp()).Delete(
                    new SpotLight()
                    {
        ...
        private void LoadData()
        {
            ...
            else
            {
                ...
                {
                    this.LblNameValue.Text = spotLight.Name;
                    this.LblHeigthValue.Text = spotLight.Heigth.ToString();
                    this.LblWidthValue.Text = spotLight.Width.ToString();
                    this.LblLengthValue.Text = spotLight.Length.ToString();
                    this.LblSlotsValue.Text = spotLight.Slots.ToString();
                    this.LblLampValue.Text = spotLight.Lamps.FirstOrDefault()?.Name;
                    this.LblSocketValue.Text = spotLight.Socket.ToString();
                }
            }
        }
