<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="SmartAquaponic.Web.Fish.Update" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LblUpdateFishTitle" runat="server" CssClass="display-4 text-success text-uppercase" />
    ...
    <asp:Panel ID="PnlMain" runat="server" CssClass="jumbotron">
        ...
        <div class="form-row">
            <div class="form-group col-md col-sm-12">
                ...
                <div class="input-group">
                    <asp:TextBox ID="TxtWaterRequired" runat="server" CssClass="form-control" TextMode="Number" min="0" max="1000000" required="" />
                    <div class="input-group-prepend">
