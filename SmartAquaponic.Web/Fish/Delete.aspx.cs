...
namespace SmartAquaponic.Web.Fish
{
    ...
    public partial class Delete : CustomPage
    {
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                var result = new FishBll(this.GetUser(), this.GetIp()).Delete(
                    new Fish()
                    {
        ...
        private void LoadData()
        {
            ...
            else
            {
                ...
                {
                    this.LblNameValue.Text = fish.Name;
                    this.LblIsLonelyValue.Text = fish.IsLonely.ToString();
                    this.LblPhValue.Text = fish.Ph.ToString();
                    this.LblSizeValue.Text = fish.Size.ToString();
                    this.LblTempValue.Text = fish.Temp.ToString();
                    this.LblWaterRequiredValue.Text = fish.WaterRequired.ToString();
                }
            }
        }
