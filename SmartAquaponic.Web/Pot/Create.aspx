<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="SmartAquaponic.Web.Pot.Create" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="LblCreatePotTitle" runat="server" CssClass="display-4 text-success text-uppercase" />
    ...
    <script type="text/javascript">
        ...
        document.querySelector(colorInput).addEventListener('change', (e) => { sa.util.reBuildPot(e) });
