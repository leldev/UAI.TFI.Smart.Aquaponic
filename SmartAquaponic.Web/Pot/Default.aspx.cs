...
namespace SmartAquaponic.Web.Pot
{
    ...
    public partial class Default : CustomPage
    {
        ...
        {
            this.BtnCreate.NavigateUrl = Constants.Pages.CreatePot;
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                var item = e.Item.DataItem as Pot;
                ...
                var ltlPlants = e.Item.FindControl(Constants.Controls.LtlPlants) as Literal;
                var ltlRock = e.Item.FindControl(Constants.Controls.LtlRock) as Literal;
                ...
                ltlPlants.Text = item.Plants.Count.ToString();
                ltlRock.Text = this.GetResource(item.Rock.ToString());
                lnkUpdate.NavigateUrl = $"{Constants.Pages.UpdatePot}?{Constants.QueryStrings.Id}={item.Id}";
                lnkDelete.NavigateUrl = $"{Constants.Pages.DeletePot}?{Constants.QueryStrings.Id}={item.Id}";
            }
        }
    }
}