...
{
    public partial class MostUsed : CustomPage
    {
        /// <inheritdoc/>
        ...
        private void LoadData()
        {
            ...
            var parameters = new List<ReportParameter>()
            {
                ...
                new ReportParameter("HeaderCant", this.GetResource(Constants.Resources.HeaderCant)),
                new ReportParameter("Pages", this.GetResource(Constants.Resources.Pages)),
                new ReportParameter("Title", this.GetResource(Constants.Controls.LtlReportMostUsedTitle)),
            };

            this.ReportViewer.ProcessingMode = ProcessingMode.Local;
            this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Report/MostUsed.rdlc");
            var result = new ReportBll().GetMostUsed();
