...
namespace SmartAquaponic.Web.Plant
{
    ...
    public partial class Default : CustomPage
    {
        ...
        {
            this.BtnCreate.NavigateUrl = Constants.Pages.CreatePlant;
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                var item = e.Item.DataItem as Plant;
                ...
                var crcIsHydroponic = e.Item.FindControl(Constants.Controls.CrcIsHydroponic) as CircleControl;
                var crcIsLowLight = e.Item.FindControl(Constants.Controls.CrcIsLowLight) as CircleControl;
                ...
                crcIsHydroponic.Checked = item.IsHydroponic;
                crcIsLowLight.Checked =  item.IsLowLight;
                lnkUpdate.NavigateUrl = $"{Constants.Pages.UpdatePlant}?{Constants.QueryStrings.Id}={item.Id}";
                lnkDelete.NavigateUrl = $"{Constants.Pages.DeletePlant}?{Constants.QueryStrings.Id}={item.Id}";
            }
        }
    }
}