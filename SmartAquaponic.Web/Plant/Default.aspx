<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SmartAquaponic.Web.Plant.Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LblPlantTitle" runat="server" CssClass="display-4 text-success text-uppercase" />
        ...
        <asp:Repeater ID="RptData" runat="server">
                    ...
                    <table class="table table-hover text-center">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">
                                    <asp:Literal ID="LtlIsHydroponic" runat="server" />
                                </th>
                                <th scope="col">
                                    <asp:Literal ID="LtlIsLowLight" runat="server" />
                                </th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <sa:CircleControl ID="CrcIsHydroponic" runat="server" />
                    </td>
                    <td>
                        <sa:CircleControl ID="CrcIsLowLight" runat="server" />
                    </td>
