    ...
    public partial class Update : CustomPage
    {
        ...
        protected void BtnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var result = new TankBll(this.GetUser(), this.GetIp())
                        .Update(
                        new Tank()
                        {
        ...
        private void LoadData()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.TxtName.Text = this.tank.Name;
                    this.TxtHeigth.Text = this.tank.Heigth.ToString();
                    this.TxtLength.Text = this.tank.Length.ToString();
                    this.TxtWaterTemp.Text = this.tank.WaterTemp.ToString();
                    this.TxtWidth.Text = this.tank.Width.ToString();
                    this.FldModifiedDate.Value = this.tank.ModifiedDate.ToDateTime2();
                    ...
                    foreach (var item in decors)
                    {
                        ...
                        option.Selected = this.tank.Decors.Any(x => x.Id == item.Id);
                    ...
                    foreach (var item in waterPumps)
                    {
                        ...
                        option.Selected = this.tank.WaterPump.Id == item.Id;
                    ...
                    DdlPh.SelectedValue = ((int)this.tank.Ph).ToString();
                }
            }
        }
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (this.tank.Fishes.Any(x => x.Id == item.Id))
                {
                    txtCant.Enabled = true;
                    cbxFish.Checked = true;
                    txtCant.Text = this.tank.Fishes.Count(x => x.Id == item.Id).ToString();
                }
                else
                {
