...
namespace SmartAquaponic.Web.Product
{
    ...
    public partial class Default : CustomPage
    {
        ...
        {
            this.BtnCreate.NavigateUrl = Constants.Pages.CreateProduct;
        ...
        {
            var result = new ProductBll().Read();
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                var item = e.Item.DataItem as Product;
                ...
                var ltlTank = e.Item.FindControl(Constants.Controls.LtlTank) as Literal;
                var ltlPot = e.Item.FindControl(Constants.Controls.LtlPot) as Literal;
                var ltlSpotLight = e.Item.FindControl(Constants.Controls.LtlSpotLight) as Literal;
                ...
                // metadata
                ltlTank.Text = item.Tank.Name;
                ltlPot.Text = item.Pot.Name;
                ltlSpotLight.Text = item.SpotLight?.Name;


                lnkUpdate.NavigateUrl = $"{Constants.Pages.UpdateProduct}?{Constants.QueryStrings.Id}={item.Id}";
                lnkDelete.NavigateUrl = $"{Constants.Pages.DeleteProduct}?{Constants.QueryStrings.Id}={item.Id}";
            }
        }
    }
}