...
namespace SmartAquaponic.Web.Contact
{
    ...
    public partial class Default : CustomPage
    {
        ...
        {
            var result = new CommunicationBll().Read();
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                var item = e.Item.DataItem as Communication;
                ...
                lnkUpdate.NavigateUrl = $"{Constants.Pages.ContactUsUpdate}?{Constants.QueryStrings.Id}={item.Id}";
                lnkUpdate.Visible = !item.IsAnswered;
                circleControl.Checked = item.IsAnswered;
            }
        }
