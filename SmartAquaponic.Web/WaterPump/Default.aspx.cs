...
namespace SmartAquaponic.Web.WaterPump
{
    ...
    public partial class Default : CustomPage
    {
        ...
        {
            this.BtnCreate.NavigateUrl = Constants.Pages.CreateWaterPump;
        ...
        {
            var result = new WaterPumpBll().Read();
        ...
        private void RptData_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                var item = e.Item.DataItem as WaterPump;
                ...
                lnkUpdate.NavigateUrl = $"{Constants.Pages.UpdateWaterPump}?{Constants.QueryStrings.Id}={item.Id}";
                lnkDelete.NavigateUrl = $"{Constants.Pages.DeleteWaterPump}?{Constants.QueryStrings.Id}={item.Id}";
            }
        }
    }
}